...
public class RecipeMappingProvider {
    ...
    public RecipeMappingProvider() {
        ...
        recipeMap.put("0TT_EWIM_NO_CHHP",
            new RecipeCombination("MIW7-51", "MIW7-61", "EWIM1-36"));
        recipeMap.put("1TT_EWIM_NO_CHHP",
            new RecipeCombination("MIW7-52", "MIW7-62", "EWIM1-46"));
        recipeMap.put("2TT_EWIM_NO_CHHP",
            new RecipeCombination("MIW7-51", "MIW7-61", "EWIM2-36"));
        recipeMap.put("3TT_EWIM_NO_CHHP",
            new RecipeCombination("MIW7-52", "MIW7-62", "EWIM2-46"));
